  ...
  window.renderSettings=function(){
    ...
    el.innerHTML=`<div class="two settings-top-grid">
      <div class="settings-left-stack">
        <div class="hero settings-control-center"><div class="eyebrow">CONTROL CENTER</div><h2>⚙️ Settings</h2><p>Theme, currency and LifeOS backup controls.</p></div>
